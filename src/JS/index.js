...
const alterTheme = document.getElementById("theme"); 
...
alterTheme.addEventListener("click", function(){
    ...
    if(darkModeOn){
        imageAlterTheme.setAttribute("src", "./src/Sprites/Light mode.png");
    }else{
        imageAlterTheme.setAttribute("src", "./src/Sprites/Night mode.png");
    }
});
